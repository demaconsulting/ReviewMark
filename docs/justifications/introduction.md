...
This document contains the justifications for the requirements of the ReviewMark project.

## Purpose

This justifications document provides the rationale behind each requirement in the ReviewMark
