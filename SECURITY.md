...
- Use the latest version of ReviewMark to benefit from security updates

### Dependencies

- Keep ReviewMark and its dependencies up to date
...
- Run ReviewMark with the minimum required permissions
- Avoid running ReviewMark as a privileged user unless necessary
...
ReviewMark reads and writes files on the local file system. Users should:
...
ReviewMark relies on third-party packages. We:
...
Thank you for helping keep ReviewMark and its users safe!

[security-advisories]: https://github.com/demaconsulting/ReviewMark/security/advisories
[issues]: https://github.com/demaconsulting/ReviewMark/issues
