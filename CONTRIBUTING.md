...
- **Environment**: Operating system, .NET version, ReviewMark version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/ReviewMark.git
   cd ReviewMark
   ```
...
ReviewMark uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
[code-of-conduct]: https://github.com/demaconsulting/ReviewMark/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/ReviewMark/discussions
[issues]: https://github.com/demaconsulting/ReviewMark/issues
[security]: https://github.com/demaconsulting/ReviewMark/blob/main/SECURITY.md
